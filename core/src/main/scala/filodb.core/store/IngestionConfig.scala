...
final case class StoreConfig(flushInterval: FiniteDuration,
                             ...
                             tsIndexFlushMaxDelaySeconds: Int,
                             tsIndexFlushMinDelaySeconds: Int,
  ...
  def toConfig: Config =
    ConfigFactory.parseMap(Map("flush-interval" -> (flushInterval.toSeconds + "s"),
                               ...
                               "part-index-flush-max-delay" -> (tsIndexFlushMaxDelaySeconds + "s"),
                               "part-index-flush-min-delay" -> (tsIndexFlushMinDelaySeconds + "s"),
